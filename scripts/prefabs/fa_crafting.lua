...
MakePlacer( "common/fa_distiller_placer", "fa_distiller", "fa_distiller", "idle_far",nil,nil,nil,0.50 ),
Prefab( "common/fa_keg", kegfn, kegassets),
MakePlacer( "common/fa_keg_placer", "fa_keg", "fa_keg", "idle_far",nil,nil,nil,0.50 ),
Prefab( "common/fa_alchemytable", alchemyfn, alchemyassets),
MakePlacer( "common/fa_alchemytable_placer", "fa_alchemytable", "fa_alchemytable", "idle_far",nil,nil,nil,1.15 ),
Prefab( "common/fa_forge", forgefn, forgeassets),
MakePlacer( "common/fa_forge_placer", "fa_forge", "fa_forge", "idle_far",nil,nil,nil,1.5 ),
Prefab( "common/fa_smeltingfurnace", smelterfn, smelterassets),
MakePlacer( "common/fa_smeltingfurnace_placer", "fa_smeltingfurnace", "fa_smeltingfurnace", "idle_far",nil,nil,nil,1.7 )
